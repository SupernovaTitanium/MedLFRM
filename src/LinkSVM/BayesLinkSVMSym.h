//
// Created by jiaming on 15-3-16.
//

#ifndef _MEDLFRM_BAYESLINKSVMSYM_H_
#define _MEDLFRM_BAYESLINKSVMSYM_H_
...
#include "../utils/NormalGammaPrior.h"


class BayesLinkSVMSym {
 public:
  BayesLinkSVMSym();

  BayesLinkSVMSym(Params *pParam);

  ~BayesLinkSVMSym();

  double train(char *dir, Corpus *c);

  double update_hyperparam();
...
//	char m_sample;
  ...
  double *m_dWExp_;
  double m_dMu0;
  NormalGammaPrior *m_pNormGammaPrior;
};


#endif //_MEDLFRM_BAYESLINKSVMSYM_H_
